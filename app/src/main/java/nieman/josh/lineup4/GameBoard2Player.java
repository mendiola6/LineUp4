 ...
 */
public class GameBoard2Player extends View {
    ...
    //some constructors
    public GameBoard2Player(Context context){
        this(context,null);
    }

    public GameBoard2Player(Context context, AttributeSet attr){
        super(context,attr);
    ...
    public boolean onTouchEvent(MotionEvent e){
        ...
        if(e.getAction() == MotionEvent.ACTION_DOWN && winner == 0){
            ...
            if(timesCheckedForWinner == numColumns*numRows){
                winner = 5;
            }
            if(winner != 0){
                if(winner == 1){
