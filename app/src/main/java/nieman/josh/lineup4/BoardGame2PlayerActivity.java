 ...
 */
public class BoardGame2PlayerActivity extends Activity {
    ...
    private GameBoard2Player mGameboard;
    ...
    public void onCreate(Bundle savedInstance) {
        ...
        String name2 = sharedpreferences.getString(Name2, "Guest");
        ...
        mGameboard = new GameBoard2Player(getApplicationContext());
        mGameboard.setPlayer1Name(name1);
        mGameboard.setPlayer1Color(player1Color);
        mGameboard.setSizeOfBoard(7,6);
